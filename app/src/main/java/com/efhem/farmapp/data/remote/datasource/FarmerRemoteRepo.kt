...
class FarmerRemoteRepo(val context: Context, private val api: RemoteApi, private val farmersRemoteModelMapper: FarmersRemoteModelMapper,
                       private val ioDispatcher: CoroutineDispatcher =
        Dispatchers.IO) : IFarmerRemoteRepo {
